<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - SQL盲注进阶靶场 - 第二关
 * 版本: v1.0.0
 * 功能: 逗号绕过 + 布尔盲注 — 成员验证
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
 */
    ...
    <div class="tech-card">
        ...
        <div class="tech-card-body">
            ...
            <div class="alert-info">
                ...
                <span>炸炸酥网安靱场审计系统 — 成员验证功能。输入成员ID验证成员身份，系统将返回验证结果。</span>
            </div>
            ...
            <div class="alert-warning">
                <div>
                    <strong>任务目标：</strong>
                    <small>已知存在成员M-001，尝试通过注入获取通关密码。提示：WAF新增逗号拦截规则，通关密码存储在 zhazhasu_bsiadv_members 表的 member_key 字段中</small>
                </div>
            </div>
