-- ============================================================
-- Zhazhasu炸炸酥网安靱场团队 - 时间盲注靶场 - 数据库初始化脚本
-- 版本: v2.0.0
-- 数据库: zhazhasu_sqli（与报错注入靶场共享）
-- 表名前缀: zhazhasu_timesi_
...
-- 服务资产表（靶场业务数据）
-- -----------------------------------------------------------
DROP TABLE IF EXISTS zhazhasu_timesi_services;
CREATE TABLE IF NOT EXISTS `zhazhasu_timesi_services` (
...
INSERT INTO `zhazhasu_timesi_services` (`service_name`, `service_type`, `status`, `port`, `description`) VALUES
...
-- 成就记录表（全局共享模式，无会话依赖）
-- -----------------------------------------------------------
DROP TABLE IF EXISTS zhazhasu_timesi_achievements;
CREATE TABLE IF NOT EXISTS `zhazhasu_timesi_achievements` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------------
DROP TABLE IF EXISTS zhazhasu_timesi_string_functions;
CREATE TABLE IF NOT EXISTS `zhazhasu_timesi_string_functions` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
