<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - XSS HTML内容过滤靶场 - 通关API
 * 版本: v1.0.0
 * 创建日期: 2025-12-31
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
 */
...
// 设置响应头
header('X-Zhazhasu: Zhazhasu XSS通关API v1.0.0');
...
try {
    ...
    if ($level === 1 || $level === 2) {
        Zhazhasu_UpdateLearningStatus('xss_content_filter', '学习中');
    } elseif ($level === 3) {
        Zhazhasu_UpdateLearningStatus('xss_content_filter', '已掌握');
    }
