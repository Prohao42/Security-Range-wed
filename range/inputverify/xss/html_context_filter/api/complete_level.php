<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - HTML上下文XSS过滤绕过靶场 - 通关API
 * 版本: v1.0.0
 * 创建日期: 2026-01-14
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
 */
...
// 设置响应头
header('X-Zhazhasu: Zhazhasu HTML上下文XSS通关API v1.0.0');
...
try {
    ...
    if ($level === 1 || $level === 2) {
        Zhazhasu_UpdateLearningStatus('html_context_filter', '学习中');
    } elseif ($level === 3) {
        Zhazhasu_UpdateLearningStatus('html_context_filter', '已掌握');
    }
