<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - 文件相关XSS靶场 - 通关API
 * 版本: v1.0.0
 * 创建日期: 2026-03-03
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
 */
...
// 设置响应头
header('X-Zhazhasu: Zhazhasu 文件相关XSS通关API v1.0.0');
...
try {
    ...
    if ($level === 1 || $level === 2) {
        Zhazhasu_UpdateLearningStatus('filexss', '学习中');
    } elseif ($level === 3) {
        Zhazhasu_UpdateLearningStatus('filexss', '已掌握');
    }
