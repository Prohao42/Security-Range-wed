<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - 水平越权基础靶场 - 第三关通关密码验证接口
 * 版本: v1.0.0
 * 创建日期: 2026-03-05
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
 */
...
try {
    ...
    // 查询guanliyuan用户的通关密码
    $stmt = $pdo->prepare("SELECT passcode FROM zhazhasu_idref_users WHERE level = 3 AND account = 'guanliyuan'");
    $stmt->execute();
    ...
    if ($passcode === $user['passcode']) {
        // 通关成功，更新学习状态
        Zhazhasu_UpdateLearningStatusIfNeeded('idref');
