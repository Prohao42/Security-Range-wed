<?php
/**
 * Zhazhasu炸炸酥网安靱场团队 - 密码重置凭证可猜测靶场 - 第二关发送重置链接API
 * 版本: v1.0.0
 * 创建日期: 2026-01-22
 * 团队: 炸炸酥网安靱场 (Zhazhasu)
...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM zhazhasu_resetlink_users WHERE level = 2 AND username = ?");
    ...
    $result = Zhazhasu_SmsSender::send($user['phone'], $message, 'resetlink_level2');
